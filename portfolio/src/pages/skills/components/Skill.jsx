...
const Skill = ({ skill }) => {
    return (
        <div className='flex-grow flex flex-col items-center p-4 md:p-6 lg:p-8 bg-stone-900 bg-opacity-30 rounded-xl group transition duration-300 hover:scale-105 hover:bg-red_primary hover:bg-opacity-40'>
