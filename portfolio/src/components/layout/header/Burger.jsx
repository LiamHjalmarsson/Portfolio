...
const Burger = ({ open, menuHandler }) => {
    return (
        <div className="flex lg:hidden items-center justify-center w-16 h-16 z-20 order-1 p-4 rounded-full  shadow-md bg-stone-200 bg-opacity-30 dark:bg-stone-900 dark:bg-opacity-30 cursor-pointer right-4" onClick={menuHandler}>
