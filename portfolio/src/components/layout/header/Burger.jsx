...
const Burger = ({ open, menuHandler }) => {
    return (
        <div className=" fixed flex lg:hidden items-center justify-end z-20 order-1 p-4 bg-stone-800 rounded-full bg-opacity-50 shadow-lg cursor-pointer right-4" onClick={menuHandler}>
